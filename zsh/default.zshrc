...
# Source local machine-specific config (not tracked by git)
[[ -f "${XDG_CONFIG_HOME:-${HOME}/.config}/zsh/env.local.zshrc" ]] && source "${XDG_CONFIG_HOME:-${HOME}/.config}/zsh/env.local.zshrc"
